...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  {
    href: '/docs/cross-framework',
    title: 'Cross-framework remotes',
    section: 'Core',
    description: 'Embed remotes built with any framework via the neutral mount(ctx) contract — @jorvel/mount + @jorvel/adapter-react.',
    keywords: ['cross-framework', 'polyglot', 'vue', 'angular', 'solid', 'svelte', 'mount', 'unmount', 'framework-agnostic', 'framework-neutral', '@jorvel/mount', 'adapter-react', 'defineReactRemote', 'mountRemoteModule', 'micro-frontend', 'non-react', 'ssr', 'hydration', 'hydrate', 'renderToString', 'composeFragments', 'hydrateFragments', 'web component', 'custom element'],
  },
  {
    href: '/docs/polyglot',
    title: 'Polyglot monorepo',
    section: 'Core',
    description: 'React, Vue, Solid, Svelte, Angular micro-frontends in one repo, one host — jorvel generate remote --framework.',
    keywords: ['polyglot', 'multi-framework', 'multiple frameworks', 'vue', 'angular', 'solid', 'svelte', 'react', 'generate remote', '--framework', 'micro-frontend', 'monorepo', 'mixed stack', 'adapter', 'skills per app'],
  },
  {
    href: '/docs/ai-tools',
    title: 'AI coding tools',
    section: 'Resources',
    description: 'Scaffold Claude Code, Codex, Cursor, Copilot, Windsurf, Gemini config + a docs MCP server.',
    keywords: ['ai', 'claude', 'claude code', 'codex', 'cursor', 'copilot', 'github copilot', 'windsurf', 'gemini', 'mcp', 'model context protocol', 'agents.md', 'claude.md', '.cursorrules', 'skills', 'agents', 'llms.txt', 'coding assistant', 'ai-tools'],
  },
  {
    href: '/docs/adapters',
  ...
  },
  {
    ...
    section: 'Get started',
    description: 'Guided end-to-end build: scaffold, host + remote, routes, data, auth, deploy.',
    keywords: ['tutorial', 'guide', 'walkthrough', 'first app', 'learn', 'step by step', 'beginner', 'example'],
  },
  {
    href: '/docs/architecture',
    title: 'Architecture',
    section: 'Get started',
    description: 'Topology, share scope, two-tier router, SSR request lifecycle, failure isolation.',
    keywords: ['architecture', 'internals', 'share scope', 'singleton', 'lifecycle', 'mental model', 'how it works', 'advanced'],
  },
  {
    href: '/docs/api/events',
    title: '@jorvel/events API',
    section: 'API reference',
    description: 'Shared event-contract type map (MfAppEvents) for host + remotes.',
    keywords: ['events api', 'event contract', 'MfAppEvents', 'event map', 'typed events'],
  },
  {
    href: '/docs/api/types',
    title: '@jorvel/types API',
    section: 'API reference',
    description: 'Federation contract DSL, config types, redirect matchers, contract tests, JSON schemas.',
    keywords: ['types api', 'defineFederationContract', 'InferExposed', 'matchRedirect', 'json schema', 'config types', 'RouteTarget'],
  },
  {
    href: '/docs/api/rspack-route-assets',
    title: '@jorvel/rspack-route-assets API',
    section: 'API reference',
    description: 'Rspack plugin emitting a per-route asset manifest for preloading.',
    keywords: ['rspack', 'route assets', 'plugin', 'preload', 'manifest', 'chunks', 'entrypoints'],
  },
  {
    href: '/docs/api/config',
    title: 'Shared configs API',
    section: 'API reference',
    description: '@jorvel/eslint-config, prettier-config, tsconfig presets.',
    keywords: ['eslint config', 'prettier config', 'tsconfig', 'presets', 'lint', 'format', 'typescript config'],
  },
  {
    href: '/docs/concepts',
    title: 'Core concepts',
