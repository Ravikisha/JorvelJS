...
g(["generate","host","shell","--port","3000","--lang","js","--no-tailwind","--remote","dashboard"]);
g(["generate","remote","dashboard","--port","3001","--framework","react","--lang","js","--no-tailwind"]);
g(["federation"]);
console.log('');
console.log('OK React (JavaScript) host + remote - real .jsx/.js source.');
