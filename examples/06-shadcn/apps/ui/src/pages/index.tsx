...
/** ui — home route ("/"). Edit this file; it hot-reloads. */
export default function HomePage() {
  const [count, setCount] = React.useState(0);
  return (
    <div style={wrap}>
      <span style={badge}>ui · remote</span>
      <h1 style={{ fontSize: '2.1rem', lineHeight: 1.15, margin: '16px 0 8px' }}>It works! 🎉</h1>
      <p style={{ color: '#475569', fontSize: '1.06rem', margin: 0 }}>
        This page is served by the <strong>ui</strong> remote and mounted into the host via
