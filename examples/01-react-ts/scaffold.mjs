...
g(["generate","host","shell","--port","3000","--lang","ts","--no-tailwind","--remote","dashboard"]);
g(["generate","remote","dashboard","--port","3001","--framework","react","--lang","ts","--no-tailwind"]);
g(["federation"]);
console.log('');
console.log('OK React (TypeScript) host + remote - real .tsx source.');
