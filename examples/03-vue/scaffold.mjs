...
g(["generate","host","shell","--port","3000","--lang","ts","--no-tailwind","--remote","storefront"]);
g(["generate","remote","storefront","--port","3001","--framework","vue","--lang","ts","--no-tailwind"]);
g(["federation"]);
console.log('');
console.log('OK React host + Vue 3 remote - real .vue SFC.');
