---
name: vue-remote
description: Build and modify the storefront Vue 3 remote — mount contract, exposed ./App, framework conventions. Trigger when work is scoped to apps/storefront/.
---

# storefront — Vue 3 remote
...
- After adding pages/routes, keep them internal to this remote (storefront owns `/storefront/*`).
