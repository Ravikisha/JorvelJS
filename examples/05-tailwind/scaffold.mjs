...
g(["generate","host","shell","--port","3000","--lang","ts","--tailwind","--remote","marketing"]);
g(["generate","remote","marketing","--port","3001","--framework","react","--lang","ts","--tailwind"]);
g(["federation"]);
console.log('');
console.log('OK React host + remote with Tailwind CSS.');
